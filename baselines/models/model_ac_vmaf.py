...
class Actor(torch.nn.Module):
    def __init__(self, action_space):
        ...
        self.actor_conv1 = nn.Conv1d(
            self.input_channel, channel_cnn, 4
        )  # L_out = 8 - (4-1) -1 + 1 = 5
        self.actor_conv2 = nn.Conv1d(self.input_channel, channel_cnn, 4)
        self.actor_conv3 = nn.Conv1d(
            self.input_channel, channel_cnn, 4
        ...
        # ===================Hide layer=========================
        incoming_size = 2 * channel_cnn * 5 + 2 * channel_cnn * 3 + 3 * channel_fc  #
